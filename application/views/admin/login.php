...
<html lang="zh"><head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/admin/css/premium.css">
</head>
         ...
         <form action="" method="post">
               <input type="hidden" name="_csrf_token" value="" />
                <div class="form-group">
                    ...
                    <input type="text" id="username" class="form-control span12" name="name" value="" required="required" />
                </div>
                <div class="form-group">
