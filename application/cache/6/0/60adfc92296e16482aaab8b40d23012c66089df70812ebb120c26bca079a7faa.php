...
/* admin/sys/admin.twig */
class __TwigTemplate_60adfc92296e16482aaab8b40d23012c66089df70812ebb120c26bca079a7faa extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("layout/esui.twig", "admin/sys/admin.twig", 2);
        $this->blocks = array(
    ...
    {
        // line 4
        echo "    <div class=\"easyui-panel\" title=\"管理员管理\" data-options=\"iconCls:'icon-user2',collapsible:true,fit:true,border:false\" >
        <div id=\"tb\" style=\"padding:5px;height:auto\">  
            <div style=\"margin-bottom:5px\">
                <a href=\"/admin/sys/addAdmin\" class=\"easyui-linkbutton\" iconCls=\"icon-add\" plain=\"true\">添加</a>
        ...
        \$(function () {
            ...
            \$('#dg').datagrid({
                ...
                columns: [[
                        ...
                        {field: 'mname', title: '昵称'},
                        {field: 'mail', title: '邮箱'},
                        {field: 'gname', title: '角色'},
                        {field: 'action', title: \"操作\", width: 20, formatter: function (value, row, index) {
                                return \"<a class='cwp-btn' title='编辑' href='/admin/sys/editAdmin/id/\" + row.id + \"'><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>\" +
