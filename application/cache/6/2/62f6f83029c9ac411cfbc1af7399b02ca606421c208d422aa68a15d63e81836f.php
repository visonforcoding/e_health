...
/* admin/sys/group.twig */
class __TwigTemplate_62f6f83029c9ac411cfbc1af7399b02ca606421c208d422aa68a15d63e81836f extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("layout/esui.twig", "admin/sys/group.twig", 2);
        $this->blocks = array(
    ...
    {
        // line 4
        echo "    <div class=\"easyui-panel\" title=\"群组管理\" data-options=\"iconCls:'icon-user2',collapsible:true,fit:true,border:false\" >
        <div id=\"tb\" style=\"padding:5px;height:auto\">  
            <div style=\"margin-bottom:5px\">
                <a href=\"/admin/sys/addGroup\" class=\"easyui-linkbutton\" iconCls=\"icon-add\" plain=\"true\">添加</a>
...
\t\t\t}},
                        {field: 'action', title: \"操作\", width: 20, formatter: function (value, row, index) {
                                return \"<a class='cwp-btn' title='编辑' href='/admin/sys/editGroup/id/\" + row.id + \"'><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>\" +
