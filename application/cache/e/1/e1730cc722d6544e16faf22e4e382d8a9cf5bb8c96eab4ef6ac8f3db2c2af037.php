...
/* admin/engineer/index.twig */
class __TwigTemplate_e1730cc722d6544e16faf22e4e382d8a9cf5bb8c96eab4ef6ac8f3db2c2af037 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout/esui.twig", "admin/engineer/index.twig", 1);
        $this->blocks = array(
    ...
    public function block_main($context, array $blocks = array())
    {
        ...
        <div id=\"tb\" style=\"padding:5px;height:auto\">  
            <div style=\"margin-bottom:5px\">
                <a href=\"/admin/engineer/addEngineer\"  class=\"easyui-linkbutton\" iconCls=\"icon-add\" plain=\"true\">添加</a>
...
";
    ...
    public function block_script($context, array $blocks = array())
    {
        ...
        \$(function () {
            \$('#dg').datagrid({
                url: \"/admin/engineer/getEngineer.html\",
                pagination: true,
                ...
                columns: [[
                        ...
                        {field: 'action', title: \"操作\", width: 20, formatter: function (value, row, index) {
                                return \"<a class='cwp-btn' title='编辑' href='/admin/engineer/editEngineer/id/\" + row.id + \"'><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>\" +
...
";
    ...
    {
        return "admin/engineer/index.twig";
    }
