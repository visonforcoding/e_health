...
class __TwigTemplate_e13c0badad500dfdbf345fb7f44dacba0ec59a51b0e11be12bb35fb5f4d21707 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout/esui.twig", "admin/article/index.twig", 1);
        $this->blocks = array(
    ...
    public function block_main($context, array $blocks = array())
    {
        ...
        <div id=\"tb\" style=\"padding:5px;height:auto\">  
            <div style=\"margin-bottom:5px\">
                <a href=\"/admin/article/addArticle\"  class=\"easyui-linkbutton\" iconCls=\"icon-add\" plain=\"true\">添加</a>
...
";
    ...
    public function block_script($context, array $blocks = array())
    {
        ...
        \$(function () {
            \$('#dg').datagrid({
                url: \"/admin/article/getArticle.html\",
                pagination: true,
                ...
                columns: [[
                        ...
                        {field: 'action', title: \"操作\", width: 20, formatter: function (value, row, index) {
                                return \"<a class='cwp-btn' title='编辑' href='/admin/article/editArticle/id/\" + row.id + \"'><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>\" +
