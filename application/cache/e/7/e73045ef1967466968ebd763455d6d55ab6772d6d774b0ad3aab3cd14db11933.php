...
/* admin/store/store_add.twig */
class __TwigTemplate_e73045ef1967466968ebd763455d6d55ab6772d6d774b0ad3aab3cd14db11933 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout/esui.twig", "admin/store/store_add.twig", 1);
        $this->blocks = array(
...
";
    ...
    {
        // line 7
        echo "    <div class=\"easyui-panel\" title=\"添加店铺\" data-options=\"iconCls:'icon-user2',collapsible:true,fit:true,border:false\" >
        <div style=\"margin: 10px 0;\"></div>
        <div class=\"form-box\" style=\"padding: 10px 0 10px 20px\">
            <form id=\"node-form\" class=\"form-inline\"  action=\"/admin/store/addStore\" method=\"post\" enctype=\"multipart/form-data\">
                ...
                <div class=\"input-group\">
                    ...
                    <input type=\"text\" name=\"storeName\" class=\"easyui-textbox\" precision=\"2\" data-options=\"required:true\"  aria-describedby=\"basic-addon1\">
                </div>
                <div class=\"input-group\">
                    <span class=\"input-group-addon\" >店主姓名</span>
                    <input type=\"text\" name=\"bossName\" class=\"easyui-textbox\" precision=\"2\" data-options=\"required:true\"  aria-describedby=\"basic-addon1\">
                </div>
                <div class=\"input-group\">
                    <span class=\"input-group-addon\" >电话号码</span>
                    <input type=\"text\" name=\"bossTel\" class=\"easyui-textbox\" precision=\"2\" data-options=\"required:true\"  aria-describedby=\"basic-addon1\">
                </div>
                <div class=\"input-group\">
                    <span class=\"input-group-addon\" >地址</span>
                    <input type=\"text\" name=\"storeAddress\" class=\"easyui-textbox\" precision=\"2\" data-options=\"required:true\"  aria-describedby=\"basic-addon1\">
                </div>
                <div class=\"input-group\">
                    <span class=\"input-group-addon\" >坐标</span>
                    <input type=\"text\" id=\"coordinate\" name=\"coordinate\" class=\"easyui-textbox\" precision=\"2\" data-options=\"required:true\"  aria-describedby=\"basic-addon1\">
                    <a href=\"javascript:void(0)\" class=\"easyui-linkbutton\" onclick=\"getLocation();\">拾取</a>
                </div>
                <div class=\"input-group\">
                    <span class=\"input-group-addon\" >营业时间</span>
                    <input type=\"text\" name=\"openTime\" class=\"easyui-textbox\" precision=\"2\" data-options=\"required:true\"  aria-describedby=\"basic-addon1\">
                </div>
                <div class=\"input-group\">
                ...
                <div class=\"input-group\">
                    ...
                    <script id=\"orderNotice\" name=\"orderNotice\" style=\"width:80%;height: 100px;margin-left:70px;\" type=\"text/plain\"></script>
                </div>
                <div class=\"input-group\">
                    <span class=\"input-group-addon\">服务须知</span>
                    <script id=\"serviceNotice\" name=\"serviceNotice\" style=\"width:80%;height: 100px;margin-left:70px;\" type=\"text/plain\"></script>
                </div>
                <div class=\"input-group\">
...
";
    ...
    {
        return "admin/store/store_add.twig";
    }
    ...
    {
        return array (  129 => 89,  126 => 88,  42 => 7,  39 => 6,  33 => 3,  30 => 2,  11 => 1,);
    }
}
