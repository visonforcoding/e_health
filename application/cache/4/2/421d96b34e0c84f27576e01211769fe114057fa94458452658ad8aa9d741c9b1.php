...
/* /shop/employee/employeeList.twig */
class __TwigTemplate_421d96b34e0c84f27576e01211769fe114057fa94458452658ad8aa9d741c9b1 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("/shop/layout/layout.twig", "/shop/employee/employeeList.twig", 1);
        $this->blocks = array(
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 3
        $context["page_header_title"] = "员工管理";
        // line 1
    ...
    <script>
                \$(function () {
                    \$(\"#list\").jqGrid({
                        ...
                        datatype: \"json\",
                        mtype: \"POST\",
                        colNames: [\"员工编号\", \"入职日期\", \"真实姓名\", \"email\", \"身份证\", \"性别\", \"手机\", \"离职状态\", \"操作\"],
                        colModel: [
                            ...
                            {name: \"gender\",width:40, editable: true, editrules: {edithidden: true}, formatter: function (cellvalue, options, rowObject) {
                                    if (cellvalue === '1') {
                                        return '男';
                                    } else {
                                        return '女';
...
";
    ...
    {
        return "/shop/employee/employeeList.twig";
    }
