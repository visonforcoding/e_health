...
/* admin/service/index.twig */
class __TwigTemplate_b87bfb0de440982f4a186a909e391e8afaf24f35578647b5a966a8c2fbf097a0 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("layout/esui.twig", "admin/service/index.twig", 2);
        $this->blocks = array(
    ...
    {
        // line 4
        echo "    <div class=\"easyui-panel\" title=\"服务管理\" data-options=\"iconCls:'icon-user2',collapsible:true,fit:true,border:false\" >
        <div id=\"tb\" style=\"padding:5px;height:auto\">  
            <div style=\"margin-bottom:5px\">
                <a href=\"/admin/service/addService\"  class=\"easyui-linkbutton\" iconCls=\"icon-add\" plain=\"true\">添加</a>
...
";
    ...
    public function block_script($context, array $blocks = array())
    {
        ...
        \$(function () {
            \$('#dg').datagrid({
                url: \"/admin/service/getService.html\",
                pagination: true,
                ...
                columns: [[
                        ...
                        {field: 'cover', title: '示意图', formatter: function (value, row, index) {
                                return '<img src=\"' + value + '\" width=\"50px;\"/>';
                            }},
                    ";
        // line 48
        echo "                        {field: 'ctime', title: '创建时间', sortable: true},
                        {field: 'utime', title: '修改时间', sortable: true},
                        {field: 'stime', title: '服务时长', sortable: true},
                        ...
                        {field: 'action', title: \"操作\", width: 20, formatter: function (value, row, index) {
                                return \"<a class='cwp-btn' title='编辑' href='/admin/service/editService/id/\" + row.id + \"'><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>\" +
...
";
    ...
    {
        return "admin/service/index.twig";
    }
    ...
    {
        return array (  81 => 48,  59 => 26,  56 => 25,  32 => 4,  29 => 3,  11 => 2,);
    }
}
